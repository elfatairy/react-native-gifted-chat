...
class MessageContainer extends React.PureComponent {
    constructor() {
        ...
        this.renderRow = ({ item, index, }) => {
            ...
            const { messages, user, inverted, messageAnimation, ...restProps } = this.props;
            if (messages && user) {
                ...
                return (<Animated.View entering={messageAnimation}>
    ...
    render() {
        ...
        onEndReachedThreshold={0.1} {...this.props.listViewProps}/>
