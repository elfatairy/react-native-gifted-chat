...
class MessageContainer extends React.PureComponent {
        ...
        this.renderRow = ({ item, index, }) => {
            ...
            if (messages && user) {
                ...
                const isLatestMessage = !inverted
                    ...
                    : index === 0;
                return (<Animated.View entering={!this.state.initialRender && isLatestMessage ? entering : undefined}>
    ...
    render() {
        ...
        <Animated.FlatList ref={this.props.forwardRef} extraData={[this.props.extraData, this.props.isTyping]} keyExtractor={this.keyExtractor} automaticallyAdjustContentInsets={false} inverted={inverted} data={this.props.messages} style={styles.listStyle} contentContainerStyle={styles.contentContainerStyle} renderItem={this.renderRow} {...this.props.invertibleScrollViewProps} ListEmptyComponent={this.renderChatEmpty} ListFooterComponent={inverted ? this.renderHeaderWrapper : this.renderFooter} ListHeaderComponent={inverted ? this.renderFooter : this.renderHeaderWrapper} onScroll={this.handleOnScroll} scrollEventThrottle={1000 / 60} onLayout={this.onLayoutList} onEndReached={this.onEndReached} entering={FadeIn.duration(250)} exiting={FadeOut.duration(250)} itemLayoutAnimation={LinearTransition.duration(400)} onEndReachedThreshold={0.1} {...this.props.listViewProps}/>
